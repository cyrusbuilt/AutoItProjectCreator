...
# Script Version .: 1.0.9.3
# NSIS Version ...: 2.46
# Date ...........: 1/25/2011
# Modified .......: 2/14/2011
# Author .........: Chris Brunner (CyrusBuilt)
# Copyright ......: Released under GPL v2.
# Script Function : Installer for the 64bit version of AutoItProjectCreator.
...
!define MUI_FINISHPAGE_RUN "$INSTDIR\AutoItProjectCreator64.exe"
...
OutFile AutoItProjectCreator_setup_64.exe
...
Section -Main SEC0000
    ...
    File "..\..\AutoItProjectCreator64.exe"
    ...
    propsExist:
        ...
        IDNO noIntegrate
            ...
            File "..\..\au3.properties.aipc64"
            Rename "$0\Properties\au3.properties.aipc64" "$0\Properties\au3.properties"
        noIntegrate:
    propsNotExist:
SectionEnd
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Create New Project.lnk" "$INSTDIR\AutoItProjectCreator64.exe"
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Open Existing Project.lnk" "$INSTDIR\AutoItProjectCreator64.exe" "/opendlg"
    ...
    ${registerExtension} "$INSTDIR\AutoItProjectCreator64.exe" ".au3proj" "AutoIt Project File (.au3proj)"
SectionEnd
...
Section /o -un.Main UNSEC0000
    ...
    Delete /REBOOTOK "$INSTDIR\AutoItProjectCreator64.exe"
    Delete /REBOOTOK "$INSTDIR\AutoItProjectCreator.au3"
    Delete /REBOOTOK "$INSTDIR\changelog.txt"
    Delete /REBOOTOK "$INSTDIR\au3.properties.aipc64"
